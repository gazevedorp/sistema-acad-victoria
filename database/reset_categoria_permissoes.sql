-- Script para limpar e recriar a tabela categoria_permissoes
-- Execute no SQL Editor do Supabase

-- Excluir a tabela existente (se existir)
DROP TABLE IF EXISTS categoria_permissoes CASCADE;
...
-- Formas de Pagamento
('admin', 'formas_pagamento', 'visualizar'),
('admin', 'formas_pagamento', 'criar'),
('admin', 'formas_pagamento', 'editar'),
('admin', 'formas_pagamento', 'excluir'),

-- Templates de Fechamento
('admin', 'templates_fechamento', 'visualizar'),
('admin', 'templates_fechamento', 'criar'),
('admin', 'templates_fechamento', 'editar'),
('admin', 'templates_fechamento', 'excluir');
...
-- Formas de Pagamento (só visualizar)
('recepcao', 'formas_pagamento', 'visualizar');
